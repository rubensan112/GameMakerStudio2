...
var _w = _x2 -_x1;
var _h = _y2 -_y1;
var _columns = _w div _size; //Division, get real number.
...
{
	//left edge
	draw_sprite_part(argument0, 0, 0, _size,_size,_size, _x1, _y1 +(_size *i));
	//right edge
	draw_sprite_part(argument0, 0, _size*2, _size,_size,_size, _x1 +(_columns * _size), _y1 +(_size *i));

}
for (var i = 1; i < (_columns); i++)
{
		//top edge
	draw_sprite_part(argument0, 0, _size, 0,_size,_size, _x1 +(_size *i), _y1);
	//bottom edge
	draw_sprite_part(argument0, 0, _size, _size*2,_size,_size, _x1 +(_size *i), _y1 +(_rows * _size));
}
...
for (var i = 1; i < (_columns); i++)
{
	...
	{
		draw_sprite_part(argument0, 0, _size, _size,_size,_size, _x1 +(_size *i), _y1+ (_size *j));
	}
}